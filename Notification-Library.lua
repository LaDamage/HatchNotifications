--[[
Original made by Jxereas on v3rmillion: https://v3rmillion.net/member.php?action=profile&uid=604105

All I did was edit some text position so it looked better,
]]--
...
errorBodyText.Position = UDim2.new(0, 0, 0, 17.5)
...
infoBodyText.Position = UDim2.new(0, 0, 0, 17.5)
...
messageBodyText.Position = UDim2.new(0, 0, 0, 17.5)
...
successBodyText.Position = UDim2.new(0, 0, 0, 17.5)
...
warningBodyText.Position = UDim2.new(0, 0, 0, 17.5)
